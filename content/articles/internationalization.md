...
Localized products are inclusive, reaching people who don't use the app's primary language.  Reaching more users also happens to be good business.  But there's another class of user we should care about too.  Many may be fluent in a product's primary language, but prefer using another.  For them, a translation can be a better experience.
